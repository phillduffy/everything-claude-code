...
*会话存储示例 -> [examples/sessions](https://github.com/affaan-m/everything-claude-code/tree/main/examples/sessions)*
...
*来源：[Claude Pricing](https://platform.claude.com/docs/en/about-claude/pricing)*
...
*在我们的 50 项任务基准测试中，mgrep + Claude Code 使用了比基于 grep 的工作流少约 2 倍的 token，且判断质量相似或更好。来源：[mgrep](https://github.com/mixedbread-ai/mgrep)*
...
另请参阅：[ccstatusline](https://github.com/sirmalloc/ccstatusline)
...
* [claude-flow](https://github.com/ruvnet/claude-flow) - 拥有 54+ 个专业智能体的企业级编排平台
...
* [system-prompts-and-models-of-ai-tools](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools) - 系统提示词集合 (110k stars)
