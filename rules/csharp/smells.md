...
| **HIGH** | Block | Long Method (>25 lines), Large Class (>250 lines), Long Parameter List (>4), Data Clumps, Switch Statements (duplicated), Data Class (anemic entity), Dead Code |
...
See skill: `csharp-smells` for the complete 22-smell catalog with detection heuristics and C# fix patterns.
